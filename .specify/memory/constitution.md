...
- Modified principles:
  - [PRINCIPLE_1_NAME] → I. Mathematical & Invariant Integrity (NON-NEGOTIABLE)
  - [PRINCIPLE_2_NAME] → II. Primary Source Grounding & Traceability
  - [PRINCIPLE_3_NAME] → III. Single Source of Truth & Dual-Surface Parity
  - [PRINCIPLE_4_NAME] → IV. Automated Invariant & Schema Testing
  - [PRINCIPLE_5_NAME] → V. Operational Simplicity & Zero-Build Dashboard
- Added sections:
  - Data Architecture & Domain Constraints
  - Quality Gates & Verification Workflow
- Removed sections:
  - None (unpopulated template placeholders replaced)
...
- **Source Verification Gate**: Markdown dossiers and dashboard citations MUST satisfy `python3 src/validate_sources.py` ensuring all required reference domains and citations resolve.
- **Visual & Functional Parity**: Dashboard UI modifications MUST be verified in standard browsers to ensure responsive layout, legible data cards, and error-free console logs.
...
- **Compliance Enforcement**: Every pull request, spec, and plan MUST verify adherence to the five core principles before approval.
