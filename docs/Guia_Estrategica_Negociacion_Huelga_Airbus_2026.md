...
```mermaid
flowchart TD
    subgraph España ["Factorías en España (15.562 Trabajadores) - Fuente: SIMA / Registro Oficial"]
    ...
    subgraph Logistica ["Logística Crítica Continental - Fuente: Beluga Operations Tracker"]
        B & C --> E["Agotamiento del Buffer de Operaciones (48h - 72h)"]
        E --> F["Caída Drástica de Vuelos del BelugaXL"]
    end

    subgraph Europa ["Impacto Corporativo en FALs - Fuente: Airbus Financial Guidance"]
...
```mermaid
timeline
    title Cronología Inversa del Conflicto Airbus España 2026 - Fuente: Actas SIMA y Telegram
    29 Agosto (HOY) : Asambleas Generales de Factoría : Monitor de Presión en 85.5°C
    ...
    24 Julio : Referéndum en Urna : El 49,15% NO tumba el preacuerdo patronal
