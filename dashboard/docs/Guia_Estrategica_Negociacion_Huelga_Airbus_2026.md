...
flowchart TD
    subgraph España ["Factorías en España (Getafe, Illescas, Cádiz, Sevilla)"]
        A[Huelga Indefinida / Paros Totales] --> B[Bloqueo de HTP Comercial A320 / A321 / A330 / A350]
        A --> C[Paro de Aeroestructuras Compuestas de Fibra de Carbono]
        A --> D[Parálisis Ensayos Militares Sevilla A400M / C295]
    end

    subgraph Logistica ["Logística Crítica Continental"]
        B & C --> E[Agotamiento del Buffer de Operaciones]
        E --> F[Caída Drástica de Vuelos del Beluga]
    end

    subgraph Europa ["Impacto Corporativo en FALs"]
        F --> G[Parálisis FALs Toulouse, Hamburgo y Mobile]
        D --> H[Incumplimiento de Entregas Militares OTAN]
        G & H --> I[Ruptura del Objetivo de 870 Entregas Anuales]
        I --> J[Máxima Presión Negociadora sobre la Dirección]
    end
```
...
El análisis econométrico comparativo entre la oferta patronal fija (sin cláusula RSG real) y la plataforma unificada del Comité de Huelga demuestra la pérdida acumulada de poder adquisitivo a 5 años en función de la tasa de inflación `[Dossier de Pérdida de Poder Adquisitivo Airbus España v8, INE/BdE]`:

* **Efecto de la Inflación Compuesta a 5 Años:**
  * Con una inflación media estándar del **2,5% anual** (objetivo BCE + diferencial), el IPC acumulado a 5 años es del **+10,4%**.
  * En un escenario de reactivación inflacionaria del **5,5% anual**, la inflación acumulada a 5 años alcanza el **+23,9%**.

* **Trayectoria Salarial a 5 Años (Salario Base de 50.000 €):**

| Variable / Escenario | Situación Actual (Sin Convenio) | Oferta Empresa (+5% Fracc. + 1% débil) | Plataforma Comité (+12% Tablas + IPC+1,5% RSG) | Ganancia / Ventaja para la Plantilla |
| :--- | :---: | :---: | :---: | :---: |
| **Salario Tablas Año 1 (2026)** | 50.000 € | 52.500 € | **56.000 €** | +3.500 €/año en tablas |
| **Salario Nominal Año 5 (2030)** | 50.000 € | 53.184 € | **65.512 €** | **+12.328 €/año en nómina** |
| **Poder Compra Real Año 5 (IPC 2,5%)** | 45.289 € (-9,4%) | 48.182 € (**-3,6% de pérdida real**) | **59.351 € (+18,7% ganancia real)** | **+11.169 € de poder adquisitivo real** |
| **Poder Compra Real Año 5 (IPC 5,5%)** | 40.355 € (-19,3%) | 43.575 € (**-12,9% de pérdida real**) | **59.253 € (+18,5% ganancia real)** | **+15.678 € blindados frente a crisis** |
| **Aumento Bruto Mensual (14 pagas)** | 0 € | +179 €/mes | **+429 €/mes** | +250 €/mes adicionales de inmediato |
| **Paga Única / Atrasos Retroactivos** | 0 € | 2.000 € (No consolidable) | **7.500 € (Atrasos netos/brutos)** | +5.500 € en compensación inicial |
...
Durante más de dos décadas, Airbus articuló sus relaciones laborales mediante un pactismo de despacho concentrado en las direcciones de CCOO y UGT. La evolución electoral constata el declive sistemático de este modelo tradicional:
...
```mermaid
flowchart LR
    A["Mesa SIMA: Plataforma 27-Ago"] --> B{"¿Dirección Acepta Tablas e IPC?"}
    B -- No / Amenazas Corporativas --> C["Reactivación Inmediata de Paros Totales"]
    B -- Borrador con Cifras Consolidadas --> D["Pausa Táctica 72-120h con Papeleta Activa"]
    D --> E["Redacción y Firma de Acta Vinculante SIMA"]
    E --> F["Asambleas Generales y Votación en Urna"]
    F -- Aprobado por Mayoría --> G["Firma Convenio Colectivo VII (REGCON)"]
    F -- Rechazado en Votación --> C
```
...
```mermaid
flowchart TD
    A["Ultimátum Patronal: 'No negociamos con huelga'"] --> B{"Dilema en la Asamblea General"}
    
    B --> C["Postura del SÍ a la Pausa Táctica (Ventajas)"]
    C --> C1["1. Desarma victimismo patronal ante Gobierno y SEPI"]
    C --> C2["2. Exige actas vinculantes sesión a sesión en SIMA"]
    C --> C3["3. Oxigena salarios familiares sin recuperar buffers"]
    C --> C4["4. Test de estrés: obliga a Airbus a poner cifras en 72h"]
    
    B --> D["Postura del NO a la Pausa Táctica (Riesgos)"]
    D --> D1["1. Riesgo de desmovilización y enfriamiento de piquetes"]
    D --> D2["2. Peligro de evacuación de piezas críticas en Beluga"]
    D --> D3["3. Maniobra dilatoria patronal para ganar tiempo"]
    D --> D4["4. Percepción de debilidad o cesión ante el chantaje"]
    
    C & D --> E{"Condición de Desempate: Las 4 Líneas Rojas"}
...
## 8. Línea Temporal Inversa & Minutas Detalladas de Asambleas de Fábrica (Presente HOY $\rightarrow$ Pasado 2021)
...
## 10. Descargas Directas, Archivo de Telegram y Fuentes Primarias
